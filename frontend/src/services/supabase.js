...
// VITE_SUPABASE_ANON_KEY at runtime. Tests mock '@supabase/supabase-js' via
// the global setup file in src/__tests__/setup.js, so importing this module
// in a test environment yields a stub client that doesn't touch the network.
...
export function getSupabase() {
  ...
  if (!url || !key) {
    ...
    _client = createClient('http://placeholder.invalid', 'placeholder-anon-key')
    return _client
  }
